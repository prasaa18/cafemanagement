...
export class ManageOrderComponent implements OnInit {
  ...
  getCategorys() {
    this.categoryService.getFliterCategory().subscribe((response) => {
  ...
  validateSubmit() {
    if (this.totalAmount == 0 || this.manageOrderForm.controls['name'].value == null ||
      ...
      || this.manageOrderForm.controls['name'].value == null || this.manageOrderForm.controls['paymentMethod'].value == null) {
  ...
  add() {
    ...
    if (productName == undefined) {
      ...
      this.dataSource.push({
        id: formData.product.id, name: formData.product.name, category: formData.category.name, quantity: formData.quantity,
