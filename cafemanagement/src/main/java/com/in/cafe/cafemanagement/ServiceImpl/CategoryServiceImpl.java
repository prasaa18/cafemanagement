...
import com.in.cafe.cafemanagement.service.CategoryService;
        ...
        try {
            ...
            if (jwtFilter.isAdmin()) {
                if (validateCategoryMap(requestMap, false)) {
                    ...
                    return CafeUtils.getResponceEntity("Category added Successfully ", HttpStatus.OK);
                }
            ...
            if (jwtFilter.isAdmin()) {
                ...
                if (validateCategoryMap(requestMap, true)) {
                    ...
                    if (!optional.isEmpty()) {
                        ...
                        return CafeUtils.getResponceEntity("Category Updated Successfully", HttpStatus.OK);


                    } else {
                        return CafeUtils.getResponceEntity("Category id Doesn't exist", HttpStatus.OK);
